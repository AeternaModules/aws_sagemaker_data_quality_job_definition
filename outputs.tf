...
output "sagemaker_data_quality_job_definitions_data_quality_app_specification" {
  ...
  value       = { for k, v in aws_sagemaker_data_quality_job_definition.sagemaker_data_quality_job_definitions : k => one(v.data_quality_app_specification) if v.data_quality_app_specification != null && length(v.data_quality_app_specification) > 0 }
}
output "sagemaker_data_quality_job_definitions_data_quality_baseline_config" {
  ...
  value       = { for k, v in aws_sagemaker_data_quality_job_definition.sagemaker_data_quality_job_definitions : k => one(v.data_quality_baseline_config) if v.data_quality_baseline_config != null && length(v.data_quality_baseline_config) > 0 }
}
output "sagemaker_data_quality_job_definitions_data_quality_job_input" {
  ...
  value       = { for k, v in aws_sagemaker_data_quality_job_definition.sagemaker_data_quality_job_definitions : k => one(v.data_quality_job_input) if v.data_quality_job_input != null && length(v.data_quality_job_input) > 0 }
}
output "sagemaker_data_quality_job_definitions_data_quality_job_output_config" {
  ...
  value       = { for k, v in aws_sagemaker_data_quality_job_definition.sagemaker_data_quality_job_definitions : k => one(v.data_quality_job_output_config) if v.data_quality_job_output_config != null && length(v.data_quality_job_output_config) > 0 }
}
output "sagemaker_data_quality_job_definitions_job_resources" {
  ...
  value       = { for k, v in aws_sagemaker_data_quality_job_definition.sagemaker_data_quality_job_definitions : k => one(v.job_resources) if v.job_resources != null && length(v.job_resources) > 0 }
}
...
output "sagemaker_data_quality_job_definitions_network_config" {
  ...
  value       = { for k, v in aws_sagemaker_data_quality_job_definition.sagemaker_data_quality_job_definitions : k => one(v.network_config) if v.network_config != null && length(v.network_config) > 0 }
}
...
output "sagemaker_data_quality_job_definitions_stopping_condition" {
  ...
  value       = { for k, v in aws_sagemaker_data_quality_job_definition.sagemaker_data_quality_job_definitions : k => one(v.stopping_condition) if v.stopping_condition != null && length(v.stopping_condition) > 0 }
}
